...
export const generateTrainingPlanFromAI = async (userProfileData: any): Promise<string> => {
  try {
    const prompt = "Jestes trenerem personalnym. Napisz mi jedno przykladowe cwiczenie silowe.";
